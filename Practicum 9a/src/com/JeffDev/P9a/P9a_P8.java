...
class Computer implements Goed {
    ...
    @Override
    public String toString() {
        return String.format("Computer: %s met bouwjaar %s heeft een waarde van: €%s", type, productieJaar, Utils.euroBedrag(huidigeWaarde()));
    }
}
...
abstract class Voertuig implements Goed {
    ...
    @Override
    public String toString() {
        return String.format("Voertuig: %s met bouwjaar %s heeft een waarde van: €%s", type, jaar, Utils.euroBedrag(huidigeWaarde()));
    }
}
